    ...
    const renderHeader = useCallback(({
        ...
        return ( <
            TableHeader className = {
                classNames(classes.tableCell, classes.flexContainer, classes.noClick)
            }
            column = {
                column
            }
            ...
            ({
                ...
                return ( <
                    ...
                    noRowsRenderer = {
                        ...
                        style = {
                            {
                                height: screenWidth > screenHeight ? screenHeight : screenHeight
                            }
                        }
                        rowStyle = {
                            ({
                                index
                            }) => index > -1 && sortedData[index].id === selectedId ? {
                                backgroundColor: '#666'
                            } : {
                                undefined
                            }
                        ...
                        } >
                        {
                            columns.map((column, index) => {
                                ...
                                return ( <
                                    ...
                                    headerRenderer = {
                                        (headerProps) => renderHeader({ ...rendererProps,
                                            ...headerProps
                                        })
                                    }
                                    key = {
                                    ...
                                    width = {
                                        Number.isInteger(column.width) ? column.width : column.width * screenWidth
                                    }
                                    />
                                )
                            })
